...
const Shadow = () => (React.createElement("group", { position: [0, 0, 0] },
    React.createElement("mesh", { key: "shadow-catcher", receiveShadow: true, position: [0, 0, 0], "rotation-x": -Math.PI / 2 },
        React.createElement("planeGeometry", { attach: "geometry", args: [3, 2] }),
...
const Lights = (lightingProps) => {
    ...
    return (React.createElement("group", null,
        React.createElement("spotLight", { position: fillLightPosition, target: targets.head, angle: LIGHT_CONFIG.fillLightAngle, color: fillLightColor, intensity: fillLightIntensity }),
        React.createElement("spotLight", { position: backLightPosition, target: targets.head, angle: LIGHT_CONFIG.backLightAngle, color: backLightColor, intensity: backLightIntensity }),
        ...
        React.createElement("directionalLight", { position: LIGHT_CONFIG.dirLightPosition, target: targets.shoe, castShadow: true, intensity: 0.0 })));
};
