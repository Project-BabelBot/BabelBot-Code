...
const Shadow = () => (React__default["default"].createElement("group", { position: [0, 0, 0] },
    React__default["default"].createElement("mesh", { key: "shadow-catcher", receiveShadow: true, position: [0, 0, 0], "rotation-x": -Math.PI / 2 },
        React__default["default"].createElement("planeGeometry", { attach: "geometry", args: [3, 2] }),
...
const Lights = (lightingProps) => {
    ...
    return (React__default["default"].createElement("group", null,
        React__default["default"].createElement("spotLight", { position: fillLightPosition, target: targets.head, angle: LIGHT_CONFIG.fillLightAngle, color: fillLightColor, intensity: fillLightIntensity }),
        React__default["default"].createElement("spotLight", { position: backLightPosition, target: targets.head, angle: LIGHT_CONFIG.backLightAngle, color: backLightColor, intensity: backLightIntensity }),
        ...
        React__default["default"].createElement("directionalLight", { position: LIGHT_CONFIG.dirLightPosition, target: targets.shoe, castShadow: true, intensity: 0.0 })));
};
